...
- 目标工况以 380 °C、28 MPa 为主，并保留 360 °C、28 MPa 作为亚临界水对照。
...
- 等温全组分多相流；
- 左侧注入水、右侧生产；
- 重点比较 360 °C 与 380 °C，以及 PR 与 CPA 的热力学结构差异。
...
- `flow_360c_cpa/`：360 °C / 28 MPa 亚临界水对照；
- `flow_380c_cpa/`：380 °C / 28 MPa 主算例；
- `flow_380c_pr/`：380 °C / 28 MPa PR 结构对照。
