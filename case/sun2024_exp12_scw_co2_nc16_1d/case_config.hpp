 ...
 * @brief Sun-2024 Exp.12 派生独立超临界水 + PR(CO2-nC16) 配置。
 */
#pragma once
...
inline constexpr char name[] = "sun2024_exp12_scw_co2_nc16_1d";
...
struct Fluid
{
    ...
    static constexpr double temperature = Sun2024Exp12::temperature;
...
struct InitialState
{
    static constexpr double pressure = Sun2024Exp12::initialPressure;
    static constexpr double temperature = Sun2024Exp12::temperature;
    static constexpr bool preserveReferenceValues = false;
    static constexpr double oilSaturation = Sun2024Exp12::targetOilSaturation;
...
struct Time
{
    static constexpr int numberOfSteps = 80;
    static constexpr double dtDays =
        Sun2024Exp12::finalTimeSeconds / numberOfSteps / Sun2024Exp12::day;
...
struct Output
{
    ...
    static constexpr std::size_t every = 4;
