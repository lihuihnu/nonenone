 ...
 * @brief 超临界 H2O-CO2-nC10 二维对比算例共享参数。
 */
#pragma once
...
inline constexpr double initialPressure = 28.0e6;
inline constexpr double temperature = 653.15;
static_assert(initialPressure > waterCriticalPressure);
static_assert(temperature > waterCriticalTemperature);
